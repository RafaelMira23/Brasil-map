  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
        ...
        <h3 style={{ fontSize: '14px', fontWeight: '600', color: 'var(--text-main)', marginBottom: '16px', paddingBottom: '8px', borderBottom: '1px solid var(--border-color)', marginTop: '30px' }}>Filtros de Oportunidades</h3>
